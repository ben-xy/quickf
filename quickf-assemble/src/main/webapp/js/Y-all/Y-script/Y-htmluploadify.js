...
define(function(require, exports, module){
	...
	Y.inherit('HtmlUploadify', 'Window', {
		...
		clearValue: function(item){
			...
			var newObj = $('<input type="file" style="float:left;" class="wnd-upload-file" name="'+fileObjName+'"/>');
			obj.after(newObj);
			obj.remove();
		},
		...
		addItem:function(){
			...
			div.append($('<input type="file" name="'+fileObjName+'" style="float:left;" class="wnd-upload-file" />'));
